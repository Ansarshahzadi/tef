    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="assets/images/logo-sms.png" alt="logo-sm-dark" height="20">
                </span>
                <span class="logo-lg">
                    <img src="assets/images/logo-darks.png" alt="logo-dark" height="30">
                </span>
            </a>

            <a href="index.html" class="logo logo-light">
                <span class="logo-sm">
                    <img src="assets/images/logo-sms.png" alt="logo-sm-light" height="20">
                </span>
                <span class="logo-lg">
                    <img src="assets/images/logo-lights.png" alt="logo-light" height="30">
                </span>
            </a>
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-wide dropdown-menu-end dropdown-menu-animated overflow-hidden py-0">
                        <div class="card border-0">
                            ...
                            <div class="card-footer card-footer-bordered rounded-0"><a href="sign_out.php" class="btn btn-label-danger">Sign out</a></div>
                        </div>
                    </div>
                </div>
                <!-- End Profile -->
